...
class UserTest < ActiveSupport::TestCase
  ...
  test "email validation should reject invalid addresses" do
    invalid_addresses = %w[user@example,com user_at_foo.org user.name@example.
                            foo@bar_baz.com foo@bar+baz.com joe.newbry@gmail..com]
  ...
  test "email addresses should be saved downcased" do
    ...
    @user.save
    @user.reload
    # hoping that the upcase email line doesn't change both
    assert @user.email == @user.email.downcase, "#{@user.email} should be downcased"
  end
